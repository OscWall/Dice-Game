...
class TestDiceHand(unittest.TestCase):
    ...
    def test_roll_pvi_pvp_easy(self, mock_randint):
    ...
    @patch('random.randint')
    def test_roll_pvi_pvp_hard(self, mock_randint):
